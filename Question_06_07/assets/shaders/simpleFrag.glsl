                      ...
                      in int lightID )
{
	...
	outDiffuse.r = myLight[lightID].diffuse.r 		// Light contribution
	                 * materialDiffuse_r				// Material contribution
					 * diffFactor;						// Factor based on direction
					 
	outDiffuse.g = myLight[lightID].diffuse.g 		// Light contribution
	                 * materialDiffuse_g				// Material contribution
					 * diffFactor;						// Factor based on direction
	
	outDiffuse.b = myLight[lightID].diffuse.b 		// Light contribution
	                 * materialDiffuse_b				// Material contribution
					 * diffFactor;						// Factor based on direction
